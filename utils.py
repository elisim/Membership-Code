...
def preprocess_data(
    data_df, normalized=True, how="standard", class_col="class", resample=True
):
    """
...
def inverse_transform(
    data_df, les, normalizer, transformed_columns, normalized=True, class_col="class"
):
    data_columns = data_df.columns[data_df.columns != class_col].tolist()
    if normalized:
        data_df[data_columns] = normalizer.inverse_transform(
            data_df[data_columns])
